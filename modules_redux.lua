...
local ConfigPath = [[C:\Users\]] .. (os.getenv("USERNAME") or "User") .. [[\AppData\Local\Potassium\workspace\Configs]]
...
FOVCircle.Radius = Config.Advantage.Radius
FOVCircle.Filled = false
FOVCircle.Visible = false
FOVCircle.Color = UI_Colors.Accent

local ScreenGui = Instance.new("ScreenGui", CoreGui)
ScreenGui.Name = "ModulesRedux_V6_5"
ScreenGui.ResetOnSpawn = false

local ExitFrame = Instance.new("Frame", ScreenGui)
ExitFrame.Size = UDim2.new(0, 320, 0, 140)
ExitFrame.Position = UDim2.new(0.5, -160, 0.5, -70)
ExitFrame.BackgroundColor3 = UI_Colors.MainBG
ExitFrame.Visible = false
ExitFrame.ZIndex = 100
Instance.new("UICorner", ExitFrame)

local ExitText = Instance.new("TextLabel", ExitFrame)
ExitText.Text = "Are You Sure You Wanna Exit?"
ExitText.Size = UDim2.new(1, 0, 0, 50)
ExitText.Position = UDim2.new(0, 0, 0, 20)
ExitText.BackgroundTransparency = 1
ExitText.TextColor3 = Color3.new(1,1,1)
ExitText.ZIndex = 101
ExitText.FontFace = Font.fromEnum(Enum.Font.Code)

local YesBtn = Instance.new("TextButton", ExitFrame)
YesBtn.Size = UDim2.new(0, 130, 0, 32)
YesBtn.Position = UDim2.new(0, 20, 0, 80)
YesBtn.BackgroundColor3 = UI_Colors.Enabled
YesBtn.Text = "YES"
YesBtn.TextColor3 = Color3.new(1,1,1)
YesBtn.ZIndex = 101
Instance.new("UICorner", YesBtn)

local NoBtn = Instance.new("TextButton", ExitFrame)
NoBtn.Size = UDim2.new(0, 130, 0, 32)
NoBtn.Position = UDim2.new(1, -150, 0, 80)
NoBtn.BackgroundColor3 = UI_Colors.Disabled
NoBtn.Text = "NO"
...
ToggleBtn.BackgroundColor3 = UI_Colors.TopBar
ToggleBtn.Text = "TOGGLE UI"
ToggleBtn.TextColor3 = UI_Colors.Accent
...
MainFrame.BackgroundColor3 = UI_Colors.MainBG
MainFrame.BorderSizePixel = 0

local TopBar = Instance.new("Frame", MainFrame)
TopBar.Size = UDim2.new(1, 0, 0, 30)
TopBar.BackgroundColor3 = UI_Colors.TopBar

local Title = Instance.new("TextLabel", TopBar)
Title.Text = "Modules Redux V6.5"
Title.Size = UDim2.new(1, -70, 1, 0)
Title.Position = UDim2.new(0, 10, 0, 0)
Title.TextColor3 = Color3.new(1,1,1)
Title.BackgroundTransparency = 1
Title.TextXAlignment = Enum.TextXAlignment.Left
Title.FontFace = Font.fromEnum(Enum.Font.Code)
...
local function CreateTab(name)
    ...
    TabBtn.TextColor3 = Color3.new(0.5, 0.5, 0.5)
    TabBtn.FontFace = Font.fromEnum(Enum.Font.Code)
    TabBtn.TextSize = 10
    ...
    TabBtn.MouseButton1Click:Connect(function()
        ...
        TabBtn.TextColor3 = UI_Colors.Accent
    end)
    return TabPage
end
...
local function AddToggle(parent, text, idx, callback)
    ...
    Btn.Position = UDim2.new(1, -20, 0.5, -7)
    Btn.BackgroundColor3 = UI_Colors.Disabled
    Btn.Text = ""
...
local PlayerScroll = Instance.new("ScrollingFrame", PlayersTab)
...
local TargetLabel = Instance.new("TextLabel", PlayersTab)
TargetLabel.Size = UDim2.new(1, 0, 0, 25)
TargetLabel.Text = "Selected: None"
TargetLabel.TextColor3 = UI_Colors.Accent
TargetLabel.BackgroundTransparency = 1
local TpBtn = Instance.new("TextButton", PlayersTab)
TpBtn.Size = UDim2.new(1, 0, 0, 30)
TpBtn.BackgroundColor3 = Color3.fromRGB(30,30,30)
TpBtn.Text = "TELEPORT TO PLAYER"
TpBtn.TextColor3 = Color3.new(1,1,1)
Instance.new("UICorner", TpBtn)
local FlingBtn = Instance.new("TextButton", PlayersTab)
FlingBtn.Size = UDim2.new(1, 0, 0, 30)
FlingBtn.BackgroundColor3 = Color3.fromRGB(30,30,30)
FlingBtn.Text = "FLING PLAYER (ULTRA SPAZ)"
FlingBtn.TextColor3 = Color3.new(1,1,1)
Instance.new("UICorner", FlingBtn)
local RefreshPBtn = Instance.new("TextButton", PlayersTab)
RefreshPBtn.Size = UDim2.new(1, 0, 0, 25)
RefreshPBtn.BackgroundColor3 = Color3.fromRGB(20,20,20)
RefreshPBtn.Text = "REFRESH LIST"
RefreshPBtn.TextColor3 = Color3.new(1,1,1)
Instance.new("UICorner", RefreshPBtn)
    ...
    for _, p in pairs(Players:GetPlayers()) do
        if p ~= LocalPlayer then
            ...
            pBtn.MouseButton1Click:Connect(function()
                SelectedPlayer = p
                TargetLabel.Text = "Selected: " .. p.Name
...
RefreshPBtn.MouseButton1Click:Connect(UpdatePlayerList)
UpdatePlayerList()
...
FlingBtn.MouseButton1Click:Connect(function()
    if SelectedPlayer and SelectedPlayer.Character and SelectedPlayer.Character:FindFirstChild("HumanoidRootPart") then
        ...
        task.spawn(function()
            local t = tick()
            while tick() - t < 2.5 do
                hrp.CFrame = targetHRP.CFrame * CFrame.Angles(math.rad(math.random(-360,360)),math.rad(math.random(-360,360)),math.rad(math.random(-360,360)))
                hrp.Velocity = Vector3.new(900000, 900000, 900000)
                RunService.Heartbeat:Wait()
                hrp.CFrame = targetHRP.CFrame * CFrame.new(0, 0, 6)
                RunService.Heartbeat:Wait()
            end
            hrp.CFrame = oldCF
...
local RefreshBtn = Instance.new("TextButton", SettingsTab)
...
local ConfigScroll = Instance.new("ScrollingFrame", SettingsTab)
ConfigScroll.Size = UDim2.new(1, 0, 0, 100)
ConfigScroll.BackgroundTransparency = 1
ConfigScroll.CanvasSize = UDim2.new(0,0,2,0)
...
RefreshBtn.MouseButton1Click:Connect(function()
    ...
    for _, f in pairs(files) do
        ...
        if name:sub(-5) == ".json" then
            local b = Instance.new("TextButton", ConfigScroll)
...
local function CreateESP(p)
    ...
    o.Tracer.Color = UI_Colors.Accent
    o.Health.Thickness = 2
    o.Health.Color = UI_Colors.Enabled
    o.Name.Size = 14
    o.Name.Center = true
    o.Name.Outline = true
    ...
    o.Dist.Center = true
    o.Dist.Outline = true
    o.Dist.Color = Color3.new(0.8,0.8,0.8)
    DrawObjects[p] = o
end
...
RunService.RenderStepped:Connect(function()
    ...
    if Config.Player.Fly then
        ...
        BodyVel.Velocity = dir * Config.Player.FlySpeed
        BodyGyro.CFrame = cf
    elseif BodyVel then 
        BodyVel:Destroy()
        BodyVel = nil
    ...
    FOVCircle.Radius = Config.Advantage.Radius
    FOVCircle.Visible = Config.Advantage.Aimbot and Config.Advantage.ShowFOV
    local target = nil
    local minDist = (Config.Misc.Ragebot and 10000) or Config.Advantage.Radius
    for _, p in pairs(Players:GetPlayers()) do
        if p ~= LocalPlayer and p.Character and p.Character:FindFirstChild("Head") and p.Character:FindFirstChildOfClass("Humanoid").Health > 0 then
            ...
            if Config.Misc.Ragebot then 
                local d = (head.Position - hrp.Position).Magnitude
                if d < minDist then minDist = d; target = head end
            elseif Config.Advantage.Aimbot and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) then
                ...
                if onS then 
                    ...
                    if mD < minDist then minDist = mD; target = head end 
                end
            end
        end
    end
    ...
    for p, o in pairs(DrawObjects) do
        if p.Character and p.Character:FindFirstChild("HumanoidRootPart") then
            ...
            local pos, onS = Camera:WorldToViewportPoint(tHRP.Position)
            ...
            if onS and d <= Config.Visual.MaxDistance then
                ...
                o.Box.Size = Vector2.new(size*0.7, size)
                o.Box.Position = Vector2.new(pos.X - o.Box.Size.X/2, pos.Y - o.Box.Size.Y/2)
                o.Box.Visible = Config.Visual.Box
                o.Health.From = Vector2.new(pos.X - size*0.35 - 5, pos.Y + size/2)
                o.Health.To = Vector2.new(pos.X - size*0.35 - 5, pos.Y + size/2 - (size * (p.Character.Humanoid.Health/p.Character.Humanoid.MaxHealth)))
                o.Health.Visible = Config.Visual.Health
                o.Name.Text = p.Name
                o.Name.Position = Vector2.new(pos.X, pos.Y - size/2 - 15)
                o.Name.Visible = Config.Visual.Name
                o.Dist.Text = math.floor(d) .. "m"
                o.Dist.Position = Vector2.new(pos.X, pos.Y + size/2 + 5)
                o.Dist.Visible = Config.Visual.Distance
                o.Tracer.From = Vector2.new(Camera.ViewportSize.X/2, Camera.ViewportSize.Y)
                o.Tracer.To = Vector2.new(pos.X, pos.Y)
                o.Tracer.Visible = Config.Visual.Tracer
